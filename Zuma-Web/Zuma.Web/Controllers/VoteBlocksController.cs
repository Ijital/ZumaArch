namespace Zuma.Web.Controllers
{
    ...
    public class VoteBlocksController : ControllerBase
    {
        ...
        //POST: api/VoteBlocks
        [HttpPost]
        // Endpoint used by miner node (INEC) for proposing vote packs for mining 
        //public async Task<ActionResult> MineVoteBlocks(IEnumerable<int> votePackIds)
        //{
        //    await _voteBlocksRepository.SaveAllAsync(voteBlocks);
        //    //return Ok(voteBlocks.Select(block => block.VoterId));
        //}
        ...
        //[HttpGet("{voteBlockLG}")]
        //// Gets Vote blocks belonging to a given local government
        //public async Task<ActionResult<IEnumerable<VoteBlock>>> GetVoteBlock(string voteBlockLG)
        //{
        //    return null;
    }
